            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="role" name="role">
                        <option value="0" <?php if ($currentUser['role'] === '0') echo 'selected'; ?>>User</option>
                        <option value="1" <?php if ($currentUser['role'] === '1') echo 'selected'; ?>>Admin</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label for="status" class="form-label">Status:</label><br>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="active" name="active" <?php if ($currentUser['status'] == 1) echo 'checked'; ?>>
                        <label class="form-check-label" for="active">Kích Hoạt</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="inactive" name="inactive" <?php if ($currentUser['status'] == 0) echo 'checked'; ?>>
                ...
                <a href="../views/index.php" class="btn btn-secondary">Back to List</a>
            </form>
        </div>
    </div>
