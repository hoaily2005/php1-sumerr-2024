                ...
                <tbody>
                    <?php foreach ($products as $product) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="../controllers/edit.php?id=<?php echo $product['id']; ?>&type=product">Edit</a>
                                <a class="btn btn-danger" href="../controllers/delete.php?id=<?php echo $product['id']; ?>&type=product">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                ...
                <ul class="pagination">
                    <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                        <li class="page-item <?php if ($i === $current_page) echo 'active'; ?>">
                            <a class="page-link" href="list_product.php?page=<?php echo $i; ?>&query=<?php echo $search_query; ?>"><?php echo $i; ?></a>
                        </li>
                    <?php endfor; ?>
                </ul>
            </nav>
