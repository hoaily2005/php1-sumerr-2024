                    ...
                    <tbody>
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../controllers/edit_user.php?id=<?php echo $user['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <a href="../controllers/delete_user.php?id=<?php echo $user['id']; ?>" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
