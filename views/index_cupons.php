...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="index_cupons.php" class="nav-link active" ><i class="far fa-newspaper"></i>Coupons</a>                  
                    </div>
                    <div class="nav-item dropdown">
    ...
    <div class="container mt-3">
        ...
        <form action="index_cupons.php" method="post">
            ...
            <input type="submit" class="btn btn-success mt-3" value="Thêm mã khuyến mãi">
        ...
        <table class="table">
            ...
            foreach ($counpons as $item) {
                ...
                echo "<td> <a class='btn btn-danger' href='../controllers/coupons/delete.php?id=$item[id]'>remove</a>
                    <a class='btn btn-info' href='../controllers/coupons/update.php?id=$item[id]'>update</a>
                </td>";
                echo "</tr>";
            }
