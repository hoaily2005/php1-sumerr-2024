                            ...
                            <ul>
                                <a href="../../controllers/logout.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                    <?php if (isset($_SESSION['username'])) : ?>
                                        ...
                                        <a href="cart.php"><span class="d-none d-lg-inline-flex fa fa-shopping-cart"></span></a>
                                    <?php else : ?>
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="product_details.php?id=<?php echo $product['id']; ?>" class="btn btn-primary bi bi-eye"> Product Details</a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                            ...
                            <ul class="pagination justify-content-center">
                                <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                                    <li class="page-item <?php if ($i === $current_page) echo 'active'; ?>">
                                        <a class="page-link" href="index_user.php?page=<?php echo $i; ?>&query=<?php echo $search_query; ?>&category=<?php echo $category_filter; ?>"><?php echo $i; ?></a>
                                    </li>
                                <?php endfor; ?>
                            </ul>
                        </nav>
